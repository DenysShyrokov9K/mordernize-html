    ...
    ManageThemeBackground: function () {
      ...
      function setnavbarbg() {
        ...
        if (nbg != undefined && nbg != "") {
          $("#" + myid + " .app-header .navbar-collapse").attr(
            "data-navbarbg",
            nbg
          );
          $("#" + myid + " .app-header").attr("data-navbarbg", nbg);
          ...
          $("#" + myid + " .app-header").attr("data-navbarbg", "skin1");
    ...
    ManageSidebarColor: function () {
      ...
      function setsidebarbg() {
        ...
        if (sbg != undefined && sbg != "") {
          ...
          $("#" + myid + " .scroll-sidebar").attr("data-sidebarbg", "skin6");
        }
      }
      setsidebarbg();
    },
